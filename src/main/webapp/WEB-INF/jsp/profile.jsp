                  	...
                  	<div class="col-md-3">
 						...
 						<div style="text-align:left; border:20pt; border-color:#f1f1f2">
	                  	...
	                  	<c:choose>
							...
							<c:choose>
									<c:when test="${resultadoAmigo == 0}">
							        <a href="../eliminarSolicitudDeAmistad/${usuario.getNombre()}" style="float:left" class="btn btn-primary btn-raised"><i class="material-icons">accessibility</i> Cancelar solicitud</a>
							        </c:when>
						 	<c:otherwise>
								   ...
								   <c:choose>
								       ...
								       <a href="../aceptarSolicitudDeAmistad/${usuario.getNombre()}" style="float:left" class="btn btn-primary btn-raised"><i class="material-icons">accessibility</i> Aceptar solicitud</a>
								    ...
								    <c:otherwise>
									      	<c:choose>
										       ...
										       <a href="../eliminarAmigos/${usuario.getNombre()}" style="float:left" class="btn btn-primary btn-raised"><i class="material-icons">accessibility</i> Eliminar de mis amigos</a>

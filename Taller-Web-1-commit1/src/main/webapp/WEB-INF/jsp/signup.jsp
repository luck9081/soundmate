              ...
              <form:form class="form" method="post" modelAttribute="usuario" action="registro">
                <div class="content">
                  <div class="input-group">
                    ...
                    <form:errors path="nombre"><div class="form_error"> Ingrese un nombre</div> </form:errors>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <form:errors path="email"><div class="form_error"> Ingrese un email valido</div> </form:errors>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <form:errors path="email"><div class="form_error"> Ingrese un instrumento/rol</div> </form:errors>
                  </div>
                  <div class="input-group">
                    <span class="input-group-addon">
                    ...
                    <form:errors path="localidad"><div class="form_error"> Ingrese su ubicacion</div> </form:errors>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <form:errors path="pass"><div class="form_error">Ingrese un password valido entre 10 y 20 caracteres</div> </form:errors>
                  </div>
                  <div class="checkbox">
                    <label>
